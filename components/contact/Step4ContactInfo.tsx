    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          />
          {errors.name && (
            <p id="name-error" role="alert" className="text-xs text-[#E85D5D] font-mono">
              {errors.name.message}
            </p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.email && (
            <p id="email-error" role="alert" className="text-xs text-[#E85D5D] font-mono">
      ...
      <div className="p-4 rounded-sm bg-[#0B0D0E] border border-[#171A1C] text-xs font-mono text-[#6E7376] flex items-center gap-3">
        <span className="w-2 h-2 rounded-full bg-[#4EBA87] shrink-0" />
        <span>
          CONFIDENTIALITY PROTOCOL: All technical communications and submitted briefs are protected by our standard bilateral non-disclosure agreement.
        </span>
      </div>
    </div>
  );
